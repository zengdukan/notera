export const englishMessages = Object.freeze({
  ...
  'notes.header.favorite.add': 'Add to favorites',
  'notes.header.favorite.remove': 'Remove from favorites',
  'notes.header.mode.view': 'View',
  'notes.header.mode.edit': 'Edit',
  'notes.header.more': 'More',
  'notes.header.menu.createVersion': 'Create version',
  'notes.header.menu.history': 'History',
  'notes.header.menu.export': 'Export',
  'notes.header.menu.move': 'Move',
  'notes.header.menu.copy': 'Copy',
  'notes.header.menu.trash': 'Move to trash',
  ...
  'navigation.newNote': 'New note',
  'navigation.newFolder': 'New folder',
  'navigation.newSubfolder': 'New subfolder',
  ...
  'navigation.offlineWorkspace': 'Available in this offline workspace.',
  'navigation.loadMore': 'Load more',
});
